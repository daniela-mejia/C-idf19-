...
int main ()
{
    int Num1, Num2, Num3 = 0;   //Initialize ONLY three int variables to 0.
    

    printf(" write  two valiables with a tab : \n");
    scanf("%d %d ", &Num1, &Num2);                    //Safely scan user input into variables #1 and #2 utilizing a single line.

    while (Num1 == Num2)  // compare the numbers in this conditions
    {
        printf(" %d is 0 \n", Num3);
