...
int main(void)
{
	...
	int numTotalTests = 0;      //int for total number of test that is going to run
	int numTestsRun = 0;        // number of test run 
	int numTestsPassed = 0;     //num of test passed
	char * tempReturnValue = NULL;                  //pointer and a return 
	...
	{
		/* FUNCTION CALL WITH TEST INPUT */    //-> pointing to the input-string_ptr          //-> pointing to the input-delimiter
