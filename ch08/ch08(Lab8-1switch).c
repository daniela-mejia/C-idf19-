...
unsigned long shadow_sequence_number(int placeNumber)
{
    ...
    switch (placeNumber <= 0 || placeNumber > 2300)
    {
        case 1 : newNum = 105;   
                 break ;
        case 2 : placeNumber == 1;
                 newNum = 9;
                 break ;
        case 3:  placeNumber = 2;
                 newNum = 0;
                 break;
        case 4: newNum = shadow_sequence_number(placeNumber - 1) + (placeNumber * placeNumber); 
                break;
    }
