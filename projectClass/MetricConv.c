...
int main(int i, int x)  //// Initialized two varibales, one tfor Decimal number and other for the counter in loop.
{   
    ...
    printf("********************\n");  // Use some printf to make the header of my table pretty
    printf("| Decimal |  Roman  |\n");  // Our table needs two variables in our table ( Decimal Number & Roman numeral)
    printf("| Number  |  Numeral|\n");
    printf("********************\n"); // more stuff to beautify your table header

    for(i=1; i<=100; i++)  //  Create a 'for' loop that will run throught the numbers 1 to 100 as ask in the instructtions and increment with each iteration 
    {
