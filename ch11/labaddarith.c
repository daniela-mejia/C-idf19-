...
{
    int i = 0;
    char * secondString_ptr = NULL;
    int tempvalue = 0;
    int numtestrun = 0;
    int numTestPassed = 0;
    int Therewasanerror = FALSE;
    int ThereshouldbeanErroe = FALSE;

    //INPUT STRINGS CHARACTERS AS DELIMITERS

    char inputString0[] = { "Integer/Float" };    	// Delimiter = 0x2F MEANS /
    ...
    // NO DELIMITERS FOUND ----TWO EXAMPLES

    char inputString6[] = {"This string do not have any delimiters."};
    char inputString7[] = {"!@#$%^&*()_+"}; //delimiter = 0x20

    //SOME NULL POINTER

    char inputString8[] = NULL;
    char inputString9[] = NULL;
    ...
    char inputString14[] = {" just yell , 'aahhh'"};    //delimiter 0x61
